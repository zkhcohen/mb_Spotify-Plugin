...
#pragma warning restore 4014
        ...
        public void OpenBrowser(bool AR)
        {
            string uri = GetUri();
            AuthUtil.OpenBrowser(uri, AR);
        }

        // Attempt to silently automate renewal of tokens. Broken due to Javascript redirect, most likely.
        /*
        public void TryCURL()
        {
            string uri = GetUri();
            AuthUtil.TryCURL(uri);
        }*/
